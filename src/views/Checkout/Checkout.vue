<template>
    <div class="div_class">
        <h3>Você será redirecionado para a página de pagamento</h3>
        <div class="alert alert-primary" role="alert">
            Ao fazer o pagamento, use o número do cartão 4242 42424 4242 e entre aleatoriamente cvv(3 digítos).
        </div>
