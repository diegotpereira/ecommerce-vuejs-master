<template>
  <div class="container">
    ...
    <div v-for="itr in len"  :key="itr" class="row mt-2 pt-3 justify-content-around">
      ...
      <div class="col-md-5 px-3">
        <div class="card-block px-3">
          ...
          <p id="item-price" class="mb-0 font-weight-bold"><sup>R$</sup>{{cartItem[itr-1].pPrice}} por unidade</p>
          ...
          <p id="item-total-price" class="mb-0">Valor : <sup>R$</sup><span class="font-weight-bold">{{cartItem[itr-1].pPrice*cartItem[itr-1].pQuantity}}</span></p>
          <br><a href="#" class="text-right" @click="deleteItem(cartItem[itr-1].id)">Remover do Carrinho</a>
        </div>
      </div>
      <div class="col-2"></div>
    ...
    <div class="total-cost pt-2 text-right">
      ...
      <button :disabled="isDisabled()" class="button_check" @click="checkout()" >Confirme a Compra</button>
    </div>
  </div>
</template>
